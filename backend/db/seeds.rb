...
john_kennedy = User.create(first_name: "John", last_name: "Kennedy", email: "geraldford@whitehouse.gov", gender: "male", password: "washington", password_confirmation: "washington", avatar: "https://vignette.wikia.nocookie.net/xmenmovies/images/4/40/JFK-first-class.jpg")
